...
import JobsClient from "./jobs-client.jsx";
import { getJobIndex } from "../../lib/cache.js";
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        <header className="animate-fade-in">
          ...
          <p className="mt-4 max-w-2xl text-lg text-muted sm:text-xl">
            A running list of job descriptions analyzed in the past few days.
          </p>
        ...
        <JobsClient items={items} total={total} />
      </div>
    </div>
  );
}
